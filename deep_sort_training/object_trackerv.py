...
flags.DEFINE_float('max_iou', 0.7, 'max Intersection over Union distance - deep sort parameter. default = 0.7')
flags.DEFINE_integer('maxage', 90, 'frames before detection stops - deep sort parameter. default = 90')
flags.DEFINE_integer('min_frames', 3, 'frames before track is validated - deep sort parameter. default = 3')
...
def main(_argv):
    ...
    #model_filename = 'model_data/vric.pb'
    encoder = gdet.create_box_encoder(model_filename, batch_size=1)
    # calculate cosine distance metric
    metric = nn_matching.NearestNeighborDistanceMetric("cosine", max_cosine_distance, nn_budget)
    # initialize tracker
    tracker = Tracker(metric, max_iou_distance=FLAGS.max_iou ,max_age=FLAGS.maxage , n_init =FLAGS.min_frames)
    ...
    file = open(f"./tracks/{tail}_{FLAGS.maxage}_{FLAGS.min_frames}_{FLAGS.deepsortmodel}.csv", 'w+')
